...
var channelJournalMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-journal\s+([^>]*)-->`)
var channelTimeCapsuleMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-time-capsule\s+([^>]*)-->`)
var channelQuoteMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-quote\s+([^>]*)-->`)
var channelGlossaryMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-glossary\s+([^>]*)-->`)
var channelFAQMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-faq\s+([^>]*)-->`)
var channelSkillNoteMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-skill-note\s+([^>]*)-->`)
var channelSoulNoteMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-soul-note\s+([^>]*)-->`)
var channelBackupNoteMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-backup-note\s+([^>]*)-->`)
var channelToolLessonMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-tool-lesson\s+([^>]*)-->`)
...
var channelPactMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-pact\s+([^>]*)-->`)
var channelForecastMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-forecast\s+([^>]*)-->`)
var channelLoreMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-lore\s+([^>]*)-->`)
var channelBoundaryMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-boundary\s+([^>]*)-->`)
...
var channelDockMarkerPattern = regexp.MustCompile(`<!--\s*gitclaw:channel-dock\s+([^>]*)-->`)
...
func HasChannelJournalMarker(body string) bool {
	return channelJournalMarkerPattern.MatchString(body)
}

func HasChannelTimeCapsuleMarker(body string) bool {
	return channelTimeCapsuleMarkerPattern.MatchString(body)
}

func HasChannelQuoteMarker(body string) bool {
	return channelQuoteMarkerPattern.MatchString(body)
}

func HasChannelGlossaryMarker(body string) bool {
	return channelGlossaryMarkerPattern.MatchString(body)
}

func HasChannelFAQMarker(body string) bool {
	return channelFAQMarkerPattern.MatchString(body)
}

func HasChannelSkillNoteMarker(body string) bool {
	return channelSkillNoteMarkerPattern.MatchString(body)
}

func HasChannelSoulNoteMarker(body string) bool {
	return channelSoulNoteMarkerPattern.MatchString(body)
}

func HasChannelBackupNoteMarker(body string) bool {
	return channelBackupNoteMarkerPattern.MatchString(body)
}

func HasChannelToolLessonMarker(body string) bool {
	return channelToolLessonMarkerPattern.MatchString(body)
}

func HasChannelMemoryNoteMarker(body string) bool {
	return channelMemoryNoteMarkerPattern.MatchString(body)
}
...
func HasChannelPactMarker(body string) bool {
	return channelPactMarkerPattern.MatchString(body)
}

func HasChannelForecastMarker(body string) bool {
	return channelForecastMarkerPattern.MatchString(body)
}

func HasChannelLoreMarker(body string) bool {
	return channelLoreMarkerPattern.MatchString(body)
}

func HasChannelBoundaryMarker(body string) bool {
	return channelBoundaryMarkerPattern.MatchString(body)
}
...
func HasChannelDockMarker(body string) bool {
	return channelDockMarkerPattern.MatchString(body)
}
