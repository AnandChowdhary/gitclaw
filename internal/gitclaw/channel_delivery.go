...
func isChannelDeliverableComment(body string) bool {
	return HasGitClawMarker(body) || HasChannelOutboundMarker(body) || HasChannelDeliverableMarker(body) || HasChannelReactionMarker(body) || HasChannelStatusMarker(body) || HasChannelEditMarker(body) || HasChannelTopicMarker(body)
}
