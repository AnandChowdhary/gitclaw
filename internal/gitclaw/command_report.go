...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/backup", Aliases: []string{"/backups"}, Model: "gitclaw/backup", Category: "backup", Summary: "Show expected backup branch paths and inspect fetched backups, coverage, risk posture, manifests, retention, restore plans, and search metadata.", LocalCLI: []string{"gitclaw backup verify", "gitclaw backup coverage --issue <number>", "gitclaw backup risk", "gitclaw backup manifest", "gitclaw backup list", "gitclaw backup info --issue <number>", "gitclaw backup stats", "gitclaw backup search <query>", "gitclaw backup export-jsonl", "gitclaw backup restore-plan", "gitclaw backup retention-plan"}},
