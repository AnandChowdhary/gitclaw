...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/proactive", Aliases: []string{"/cron"}, Model: "gitclaw/proactive", Category: "proactive", Summary: "Audit proactive prompt files, scheduled workflow calendars, reminder due gates, scheduled workflow metadata, and proactive risk posture.", LocalCLI: []string{"gitclaw proactive list", "gitclaw proactive schedule", "gitclaw proactive risk", "gitclaw proactive info <name>", "gitclaw proactive init", "gitclaw proactive enqueue"}},
