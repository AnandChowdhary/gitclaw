...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/channels", Aliases: []string{"/channel"}, Model: "gitclaw/channels", Category: "channels", Summary: "Audit channel bridge settings and workflow-dispatch ingress.", LocalCLI: []string{"gitclaw channels verify", "gitclaw channels list", "gitclaw channel-state"}},
