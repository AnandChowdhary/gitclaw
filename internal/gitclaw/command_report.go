...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/memory", Aliases: []string{"/memories"}, Model: "gitclaw/memory", Category: "memory", Summary: "Audit long-term memory, dated memory note metadata, and memory hygiene findings.", LocalCLI: []string{"gitclaw memory validate"}},
	...
	{Command: "/skills", Model: "gitclaw/skills", Category: "skills", Summary: "List local skill metadata, selection state, validation findings, or one focused skill info report.", LocalCLI: []string{"gitclaw skills validate", "gitclaw skills info <name>"}},
	{Command: "/soul", Model: "gitclaw/soul", Category: "soul", Summary: "Audit high-authority context files and soul validation findings.", LocalCLI: []string{"gitclaw soul validate"}},
