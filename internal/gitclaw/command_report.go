...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/memory", Aliases: []string{"/memories"}, Model: "gitclaw/memory", Category: "memory", Summary: "Audit long-term memory, provenance verification, focused memory-file metadata, search, and memory hygiene findings.", LocalCLI: []string{"gitclaw memory verify", "gitclaw memory validate", "gitclaw memory list", "gitclaw memory info <path>", "gitclaw memory search <query>"}},
	...
	{Command: "/proactive", Aliases: []string{"/cron"}, Model: "gitclaw/proactive", Category: "proactive", Summary: "Audit proactive prompt files, reminder due gates, and scheduled workflow metadata.", LocalCLI: []string{"gitclaw proactive list", "gitclaw proactive info <name>", "gitclaw proactive init", "gitclaw proactive enqueue"}},
	...
	{Command: "/skills", Model: "gitclaw/skills", Category: "skills", Summary: "List local skill metadata, trust verification, validation findings, install/upgrade plans, or one focused skill info/search report.", LocalCLI: []string{"gitclaw skills verify", "gitclaw skills validate", "gitclaw skills check", "gitclaw skills list", "gitclaw skills install-plan <target>", "gitclaw skills upgrade-plan <target>", "gitclaw skills info <name>", "gitclaw skills search <query>"}},
	{Command: "/soul", Model: "gitclaw/soul", Category: "soul", Summary: "Audit, verify, inspect, or search high-authority context files and soul validation findings.", LocalCLI: []string{"gitclaw soul verify", "gitclaw soul validate", "gitclaw soul list", "gitclaw soul info <path>", "gitclaw soul search <query>"}},
	{Command: "/tools", Model: "gitclaw/tools", Category: "tools", Summary: "Audit, verify, inspect, or search deterministic tool contracts, active outputs, and validation findings.", LocalCLI: []string{"gitclaw tools verify", "gitclaw tools validate", "gitclaw tools list", "gitclaw tools info <name>", "gitclaw tools search <query>"}},
}
