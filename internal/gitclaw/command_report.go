...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/channels", Aliases: []string{"/channel"}, Model: "gitclaw/channels", Category: "channels", Summary: "Audit channel bridge settings, workflow-dispatch ingress, outbound reply outboxes, provider contracts, and channel risk posture.", LocalCLI: []string{"gitclaw channels verify", "gitclaw channels risk", "gitclaw channels list", "gitclaw channels info <provider>", "gitclaw channel-state", "gitclaw channel-gateway", "gitclaw channel-outbox", "gitclaw channel-delivery"}},
