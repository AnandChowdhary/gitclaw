...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/bundles", Model: "gitclaw/skills", Category: "skills", Summary: "Catalog, list, inspect, risk-audit, or inspect git provenance for repo-local skill bundles that group existing skills into task profiles.", LocalCLI: []string{"gitclaw bundles catalog", "gitclaw bundles list", "gitclaw bundles risk", "gitclaw bundles provenance", "gitclaw bundles info <name>"}},
