...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/channels", Aliases: []string{"/channel"}, Model: "gitclaw/channels", Category: "channels", Summary: "Audit channel bridge settings, workflow-dispatch ingress, outbound reply outboxes, provider contracts, risk posture, queue outbound channel messages with `/channels send`, or reply from a mirrored channel issue with `/channels reply`.", LocalCLI: []string{"gitclaw channels verify", "gitclaw channels risk", "gitclaw channels list", "gitclaw channels info <provider>", "gitclaw channel-ingest", "gitclaw channel-send", "gitclaw channel-send --route <name>", "gitclaw channel-state", "gitclaw channel-gateway", "gitclaw channel-outbox", "gitclaw channel-delivery"}},
