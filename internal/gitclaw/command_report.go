...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/profile", Aliases: []string{"/profiles"}, Model: "gitclaw/profile", Category: "profile", Summary: "Catalog, show, verify, fingerprint, dry-run package, or risk-audit the repo-local profile envelope across soul, memory, skills, tools, model, proactive, backup, session, and channel gates.", LocalCLI: []string{"gitclaw profile catalog", "gitclaw profile show", "gitclaw profile verify", "gitclaw profile snapshot", "gitclaw profile manifest", "gitclaw profile export-plan", "gitclaw profile risk"}},
