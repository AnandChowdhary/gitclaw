...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/prompt", Model: "gitclaw/prompt", Category: "prompt", Summary: "Show prompt budget, truncation, context, skill, and tool-output metadata.", LocalCLI: []string{"gitclaw prompt list"}},
	{Command: "/proactive", Model: "gitclaw/proactive", Category: "proactive", Summary: "Audit proactive prompt files and scheduled workflow metadata.", LocalCLI: []string{"gitclaw proactive list", "gitclaw proactive init", "gitclaw proactive enqueue"}},
