...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/session", Model: "gitclaw/session", Category: "session", Summary: "Show or search reconstructed transcript counts, markers, trust, and hashes.", LocalCLI: []string{"gitclaw session list --backup <issue.json>"}},
