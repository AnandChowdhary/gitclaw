...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/approvals", Aliases: []string{"/approval"}, Model: "gitclaw/approvals", Category: "approval", Summary: "Inspect, prove provenance for, or risk-audit write-request approval gates without enabling write actions.", LocalCLI: []string{"gitclaw approvals list", "gitclaw approvals verify", "gitclaw approvals provenance", "gitclaw approvals risk"}},
	...
	{Command: "/backup", Aliases: []string{"/backups"}, Model: "gitclaw/backup", Category: "backup", Summary: "Show expected backup branch paths and inspect fetched backups, coverage, restore-readiness drills, risk posture, git provenance, manifests, freshness, timelines, retention, restore plans, and search metadata.", LocalCLI: []string{"gitclaw backup verify", "gitclaw backup coverage --issue <number>", "gitclaw backup drill --issue <number>", "gitclaw backup risk", "gitclaw backup provenance", "gitclaw backup manifest", "gitclaw backup list", "gitclaw backup timeline", "gitclaw backup info --issue <number>", "gitclaw backup stats", "gitclaw backup freshness", "gitclaw backup search <query>", "gitclaw backup export-jsonl", "gitclaw backup restore-plan", "gitclaw backup retention-plan"}},
	{Command: "/bundles", Model: "gitclaw/skills", Category: "skills", Summary: "List, inspect, risk-audit, or inspect git provenance for repo-local skill bundles that group existing skills into task profiles.", LocalCLI: []string{"gitclaw bundles list", "gitclaw bundles risk", "gitclaw bundles provenance", "gitclaw bundles info <name>"}},
	...
	{Command: "/profile", Aliases: []string{"/profiles"}, Model: "gitclaw/profile", Category: "profile", Summary: "Show the repo-local profile envelope, portability manifest, and profile-isolation risk posture across soul, memory, skills, tools, model, and run gates.", LocalCLI: []string{"gitclaw profile show", "gitclaw profile verify", "gitclaw profile manifest", "gitclaw profile export-plan", "gitclaw profile risk"}},
	...
	{Command: "/session", Model: "gitclaw/session", Category: "session", Summary: "Show, status-check, summarize, search, coverage-check, or risk-audit reconstructed transcript counts, markers, trust, provenance, and hashes.", LocalCLI: []string{"gitclaw session list --backup <issue.json>", "gitclaw session status --backup <issue.json>", "gitclaw session stats --backup <issue.json>", "gitclaw session coverage --backup <issue.json>", "gitclaw session risk --backup <issue.json>", "gitclaw session search <query> --backup <issue.json>"}},
	{Command: "/skills", Model: "gitclaw/skills", Category: "skills", Summary: "List local skill metadata, git provenance, trust verification, runtime metadata, risk audit, source pins, validation findings, selection/refresh/proposal/install/upgrade plans, or one focused skill info/search report.", LocalCLI: []string{"gitclaw skills verify", "gitclaw skills risk", "gitclaw skills runtime", "gitclaw skills validate", "gitclaw skills check", "gitclaw skills list", "gitclaw skills provenance", "gitclaw skills select-plan <name>", "gitclaw skills refresh-plan", "gitclaw skills sources", "gitclaw skills sources risk", "gitclaw skills sources info <name>", "gitclaw skills proposals [risk]", "gitclaw skills proposal-plan <name>", "gitclaw skills install-plan <target>", "gitclaw skills upgrade-plan <target>", "gitclaw skills info <name>", "gitclaw skills search <query>"}},
	{Command: "/soul", Model: "gitclaw/soul", Category: "soul", Summary: "Audit, map, verify, inspect git provenance for, plan edits for, risk-scan, or search high-authority context files and soul validation findings.", LocalCLI: []string{"gitclaw soul anchors", "gitclaw soul provenance", "gitclaw soul verify", "gitclaw soul risk", "gitclaw soul validate", "gitclaw soul list", "gitclaw soul edit-plan <path>", "gitclaw soul info <path>", "gitclaw soul search <query>"}},
	...
	{Command: "/tools", Model: "gitclaw/tools", Category: "tools", Summary: "Audit, verify, risk-scan, inspect exposure, progressive disclosure, prompt boundaries, approval gates, and provenance, plan runs for, search, or inspect repo-reviewed toolsets for deterministic tool contracts.", LocalCLI: []string{"gitclaw tools verify", "gitclaw tools risk", "gitclaw tools validate", "gitclaw tools list", "gitclaw tools exposure", "gitclaw tools exposure risk", "gitclaw tools defer-plan", "gitclaw tools boundary [query]", "gitclaw tools provenance [query]", "gitclaw tools toolsets", "gitclaw tools toolsets risk", "gitclaw tools toolsets provenance", "gitclaw tools toolsets info <name>", "gitclaw tools approval-plan <name>", "gitclaw tools run-plan <name>", "gitclaw tools info <name>", "gitclaw tools search <query>"}},
