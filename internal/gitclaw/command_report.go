...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/channels", Aliases: []string{"/channel"}, Model: "gitclaw/channels", Category: "channels", Summary: "Audit channel bridge settings, workflow-dispatch ingress, outbound reply outboxes, provider contracts, risk posture, queue outbound channel messages with `/channels send`, queue provider-native file deliverables with `/channels deliverable`, queue provider-visible status/progress updates, queue provider-facing availability/presence cards without socket probes, queue provider-facing channel topic/title updates without provider APIs or GitHub issue renames, queue provider message edits, probe reviewed routes, react or pin from mirrored channel issues, reply from mirrored channel issues, turn mirrored channel messages into GitHub tasks, turn mirrored channel messages into proactive GitHub watches, turn mirrored channel messages into standing-order proposal issues, save mirrored channel moments as GitHub clips, record mirrored channel attachments as GitHub metadata issues, record mirrored channel decisions as GitHub issues, record mirrored channel digests as GitHub issues, record mirrored channel journal entries as GitHub issues without mutating memory, record mirrored channel time capsules as GitHub issues without scheduling reminders or mutating the repository, preserve mirrored channel quotes as GitHub issues without mutating memory, preserve mirrored channel glossary terms as GitHub issues without mutating memory, preserve mirrored channel FAQs as GitHub issues without mutating memory, preserve mirrored channel skill lessons as GitHub issues without installing skills or mutating memory, preserve mirrored channel soul notes as GitHub issues without writing SOUL.md or mutating memory, preserve mirrored channel backup/recovery notes as GitHub issues without fetching backups, reading backup payloads, restoring files, or mutating memory, preserve mirrored channel durable-memory observations as GitHub issues without writing `.gitclaw/MEMORY.md`, promoting memory, or mutating memory, preserve mirrored channel tool lessons as GitHub issues without executing tools, installing tools, mutating tool policy, or mutating memory, capture mirrored channel ideas as GitHub issues, record mirrored channel quests as GitHub challenge issues, record mirrored channel rituals as GitHub review issues without creating schedules, record mirrored channel pacts as GitHub review issues without writing soul, memory, policy, or standing orders, record mirrored channel forecasts as GitHub prediction issues without creating reminders, betting markets, money/points tracking, schedules, or repo mutations, preserve shared mirrored channel lore as GitHub context issues without writing soul, memory, policy, skills, or repo files, capture mirrored channel kudos as GitHub issues, record mirrored channel retrospectives as GitHub issues, record mirrored channel playbooks as GitHub issues, record mirrored channel insights as GitHub issues, record mirrored channel board cards as GitHub issues, record mirrored channel checklists as GitHub issues, turn mirrored channel messages into workspace proposal issues, create reviewable channel dock requests without changing routebooks or provider routes, queue provider-facing channel warmup cards with deterministic conversation starters, capture mirrored channel incidents as GitHub issues, capture mirrored channel voice notes as GitHub transcript issues, capture mirrored channel images as GitHub visual context issues, capture mirrored channel links as GitHub link-card issues, turn mirrored channel access or pairing requests into GitHub review issues, queue mirrored channel availability replies without provider socket probes, provider APIs, session-store liveness guesses, model calls, workflow edits, or repo mutation, queue mirrored channel topic/title updates without provider APIs, GitHub issue renames, model calls, workflow edits, or repo mutation, queue mirrored channel platform-status replies without controlling adapters, queue mirrored channel browser-readiness replies without opening browser sessions, navigating pages, taking screenshots, launching browser MCP servers, executing tools, or mutating workflows, queue mirrored channel model-status replies without switching models, queue mirrored channel skill-status replies without installing skills, queue mirrored channel room-pulse cards from safe issue markers without raw body exposure, tasks, reminders, provider APIs, model calls, workflow edits, or repo mutation, queue mirrored channel quick-reply chips without executing commands, creating artifacts/tasks/reminders, provider APIs, model calls, workflow edits, or repo mutation, queue mirrored channel status-wheel spins without external randomness, command execution, status persistence, provider APIs, model calls, workflow edits, or repo mutation, queue mirrored channel safe skill-use maps without installing skills, creating proposal/rehearsal/note issues, calling models, or exposing raw skill bodies, queue mirrored channel tool-status replies without executing tools or exposing raw schemas, queue mirrored channel safe tool-use maps without executing tools, creating approval/rehearsal/run-request issues, calling models, or exposing raw schemas, queue mirrored channel backup-status replies without reading backup payloads or restoring files, queue mirrored channel backup-info replies without restoring files or exposing raw backup payloads, queue mirrored channel checkpoint-status replies without raw diffs, file bodies, commit subjects, restore, reset, clean, checkout, or repo mutation, queue mirrored channel profile-status replies without exporting, importing, switching, or mutating profiles, queue mirrored channel soul-status replies without registry contact, profile export, soul writes, or raw bodies, queue mirrored channel soul-info replies without registry contact, profile export, soul writes, memory writes, raw file bodies, or source-receipt paths, queue mirrored channel soul-risk replies without registry contact, profile export, soul writes, memory writes, raw bodies, or source-receipt paths, queue mirrored channel soul-search replies without registry contact, profile export, soul writes, raw queries, or raw bodies, queue mirrored channel memory-status replies without memory writes, external provider access, embedding vectors, or raw memory bodies, queue mirrored channel identity-status replies without granting access, queue deterministic channel dice/coin rolls without external randomness, queue deterministic channel option picks without external randomness, record channel tool results as GitHub issues without executing tools, save mirrored channel identities as GitHub contact-card issues, turn mirrored channel sessions into GitHub session handoff issues, turn mirrored channel messages into reviewed tool-run request issues, turn mirrored channel messages into tool approval-plan issues, turn mirrored channel messages into tool rehearsal issues, turn mirrored channel messages into reviewed toolset proposal issues, turn mirrored channel messages into prompt-pack proposal issues, turn mirrored channel messages into skill-bundle proposal issues, turn mirrored channel messages into skill proposal issues, turn mirrored channel messages into skill rehearsal issues, turn mirrored channel messages into soul proposal issues, turn mirrored channel messages into soul rehearsal issues, turn mirrored channel messages into memory proposal issues, turn mirrored channel messages into memory rehearsal issues, turn mirrored channel messages into backup recovery rehearsal issues, turn mirrored channel messages into backup restore request review issues, turn mirrored channel messages into checkpoint rollback rehearsal issues, turn mirrored channel messages into scheduled GitHub reminder issues, close channel-created artifacts with provider-facing acknowledgements, broadcast to multiple reviewed routes, invite reviewed routes into a GitHub issue, create a durable GitHub room, create a GitHub huddle, open a GitHub poll, record channel-origin poll votes back onto the poll issue, run a GitHub rollcall, open a GitHub RSVP and invite channel routes into it, or record channel-origin RSVP responses back onto the RSVP issue.", LocalCLI: []string{"gitclaw channels verify", "gitclaw channels risk", "gitclaw channels list", "gitclaw channels info <provider>", "gitclaw channel-ingest", "gitclaw channel-send", "gitclaw channel-status", "gitclaw channel-edit", "gitclaw channel-react", "gitclaw channel-send --route <name>", "gitclaw channel-state", "gitclaw channel-gateway", "gitclaw channel-outbox", "gitclaw channel-delivery"}},
	...
	{Command: "/tools", Model: "gitclaw/tools", Category: "tools", Summary: "Audit compact tool catalogs, fingerprint, verify, risk-scan, inspect exposure, progressive disclosure, prompt boundaries, approval gates, prompt-visible readiness gates, safe issue-native tool maps, provenance, run plans, conversation rehearsal issues, issue-native reviewed tool-run requests, and optional reviewed channel notifications for deterministic tool contracts.", LocalCLI: []string{"gitclaw tools catalog", "gitclaw tools snapshot", "gitclaw tools verify", "gitclaw tools risk", "gitclaw tools validate", "gitclaw tools list", "gitclaw tools exposure", "gitclaw tools exposure risk", "gitclaw tools defer-plan", "gitclaw tools boundary [query]", "gitclaw tools provenance [query]", "gitclaw tools toolsets", "gitclaw tools toolsets risk", "gitclaw tools toolsets provenance", "gitclaw tools toolsets info <name>", "gitclaw tools approval-plan <name>", "gitclaw tools readiness <name>", "gitclaw tools map <name>", "gitclaw tools run-plan <name>", "gitclaw tools info <name>", "gitclaw tools search <query>"}},
...
func commandSummaryForReport(entry commandCatalogEntry) string {
	...
	if !strings.Contains(summary, "reviewable channel dock requests") {
		summary += " Create reviewable channel dock requests without editing routebooks, moving provider routes, mutating workflows, persisting session routes, calling provider APIs, model calls, or repo mutation."
	}
	...
	if !strings.Contains(summary, "two-option this-or-that cards") {
		summary += " Queue provider-facing two-option this-or-that cards with deterministic lean metadata without model calls, external randomness, provider API calls, or repo mutation."
	}
	...
	if !strings.Contains(summary, "mad-libs fill-in cards") {
		summary += " Queue provider-facing mad-libs fill-in cards from bounded static templates without model calls, dynamic text generation, external randomness, game-state persistence, score tracking, provider API calls, workflow edits, or repo mutation."
	}
	...
	if !strings.Contains(summary, "tool drill cards") {
		summary += " Queue deterministic provider-facing tool drill cards from built-in read-only/metadata tool contracts without tool execution, shell execution, MCP launch, toolset activation, model calls, provider API calls, workflow edits, or repo mutation."
	}
	...
	if !strings.Contains(summary, "backup freshness gate cards") {
		summary += " Queue provider-facing backup freshness gate cards from local or read-only fetched backup metadata without branch writes, restores, GitHub API replay, model calls, provider API calls, or repo mutation."
	}
	if !strings.Contains(summary, "backup continuity gap cards") {
		summary += " Queue provider-facing backup continuity gap cards from local or read-only fetched backup metadata without branch writes, restores, GitHub API replay, model calls, provider API calls, or repo mutation."
	}
