...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/hooks", Aliases: []string{"/hook"}, Model: "gitclaw/hooks", Category: "hooks", Summary: "Audit declarative hook policy, hook specs, ignored handlers, and event-driven automation boundaries.", LocalCLI: []string{"gitclaw hooks list", "gitclaw hooks verify"}},
	...
	{Command: "/plugins", Aliases: []string{"/plugin"}, Model: "gitclaw/plugins", Category: "plugins", Summary: "Audit declarative plugin policy, plugin specs, ignored package files, and runtime extension boundaries.", LocalCLI: []string{"gitclaw plugins list", "gitclaw plugins verify"}},
	...
	{Command: "/skills", Model: "gitclaw/skills", Category: "skills", Summary: "List local skill metadata, trust verification, validation findings, selection/install/upgrade plans, or one focused skill info/search report.", LocalCLI: []string{"gitclaw skills verify", "gitclaw skills validate", "gitclaw skills check", "gitclaw skills list", "gitclaw skills select-plan <name>", "gitclaw skills install-plan <target>", "gitclaw skills upgrade-plan <target>", "gitclaw skills info <name>", "gitclaw skills search <query>"}},
