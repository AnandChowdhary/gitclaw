...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/context", Model: "gitclaw/context", Category: "context", Summary: "Show loaded context documents, explicit @file/@folder references, and deterministic tool output metadata.", LocalCLI: []string{"gitclaw context list", "gitclaw context info <path>"}},
