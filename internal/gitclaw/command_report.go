...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/channels", Aliases: []string{"/channel"}, Model: "gitclaw/channels", Category: "channels", Summary: "Audit channel bridge settings, workflow-dispatch ingress, outbound reply outboxes, provider contracts, risk posture, queue outbound channel messages with `/channels send`, queue provider-native file deliverables with `/channels deliverable`, queue provider-visible status/progress updates, queue provider message edits, probe reviewed routes, react or pin from mirrored channel issues, reply from mirrored channel issues, turn mirrored channel messages into GitHub tasks, turn mirrored channel messages into proactive GitHub watches, turn mirrored channel messages into standing-order proposal issues, save mirrored channel moments as GitHub clips, record mirrored channel attachments as GitHub metadata issues, record mirrored channel decisions as GitHub issues, record mirrored channel digests as GitHub issues, capture mirrored channel ideas as GitHub issues, capture mirrored channel kudos as GitHub issues, record mirrored channel retrospectives as GitHub issues, record mirrored channel playbooks as GitHub issues, record mirrored channel insights as GitHub issues, record mirrored channel board cards as GitHub issues, turn mirrored channel messages into workspace proposal issues, capture mirrored channel incidents as GitHub issues, capture mirrored channel voice notes as GitHub transcript issues, capture mirrored channel images as GitHub visual context issues, capture mirrored channel links as GitHub link-card issues, turn mirrored channel access or pairing requests into GitHub review issues, queue mirrored channel platform-status replies without controlling adapters, queue mirrored channel identity-status replies without granting access, save mirrored channel identities as GitHub contact-card issues, turn mirrored channel sessions into GitHub session handoff issues, turn mirrored channel messages into reviewed tool-run request issues, turn mirrored channel messages into tool approval-plan issues, turn mirrored channel messages into tool rehearsal issues, turn mirrored channel messages into skill proposal issues, turn mirrored channel messages into skill rehearsal issues, turn mirrored channel messages into soul proposal issues, turn mirrored channel messages into soul rehearsal issues, turn mirrored channel messages into memory proposal issues, turn mirrored channel messages into memory rehearsal issues, turn mirrored channel messages into backup recovery rehearsal issues, turn mirrored channel messages into backup restore request review issues, turn mirrored channel messages into checkpoint rollback rehearsal issues, turn mirrored channel messages into scheduled GitHub reminder issues, close channel-created artifacts with provider-facing acknowledgements, broadcast to multiple reviewed routes, invite reviewed routes into a GitHub issue, create a durable GitHub room, create a GitHub huddle, open a GitHub poll, record channel-origin poll votes back onto the poll issue, run a GitHub rollcall, open a GitHub RSVP and invite channel routes into it, or record channel-origin RSVP responses back onto the RSVP issue.", LocalCLI: []string{"gitclaw channels verify", "gitclaw channels risk", "gitclaw channels list", "gitclaw channels info <provider>", "gitclaw channel-ingest", "gitclaw channel-send", "gitclaw channel-status", "gitclaw channel-edit", "gitclaw channel-react", "gitclaw channel-send --route <name>", "gitclaw channel-state", "gitclaw channel-gateway", "gitclaw channel-outbox", "gitclaw channel-delivery"}},
