...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/session", Model: "gitclaw/session", Category: "session", Summary: "Catalog, show, inspect prompt provenance for, audit tool-use ledgers for, status-check, summarize, search, coverage-check, or risk-audit reconstructed transcript counts, markers, trust, provenance, and hashes.", LocalCLI: []string{"gitclaw session catalog", "gitclaw session list --backup <issue.json>", "gitclaw session provenance --backup <issue.json>", "gitclaw session tools --backup <issue.json>", "gitclaw session status --backup <issue.json>", "gitclaw session stats --backup <issue.json>", "gitclaw session coverage --backup <issue.json>", "gitclaw session risk --backup <issue.json>", "gitclaw session search <query> --backup <issue.json>"}},
