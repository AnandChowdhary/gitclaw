...
var commandCatalog = []commandCatalogEntry{
	{Command: "/agents", Aliases: []string{"/agent"}, Model: "gitclaw/agents", Category: "agents", Summary: "Catalog or audit repo-local agent policy, agent specs, single-assistant runtime boundaries, and agent risk posture.", LocalCLI: []string{"gitclaw agents catalog", "gitclaw agents list", "gitclaw agents risk", "gitclaw agents verify"}},
	...
	{Command: "/backup", Aliases: []string{"/backups"}, Model: "gitclaw/backup", Category: "backup", Summary: "Catalog backup commands, show expected backup branch paths, and inspect fetched backups, coverage, restore-readiness drills, risk posture, git provenance, manifests, freshness, continuity, timelines, retention, restore plans, and search metadata.", LocalCLI: []string{"gitclaw backup catalog", "gitclaw backup verify", "gitclaw backup coverage --issue <number>", "gitclaw backup drill --issue <number>", "gitclaw backup risk", "gitclaw backup provenance", "gitclaw backup manifest", "gitclaw backup list", "gitclaw backup timeline", "gitclaw backup info --issue <number>", "gitclaw backup stats", "gitclaw backup freshness", "gitclaw backup continuity", "gitclaw backup search <query>", "gitclaw backup export-jsonl", "gitclaw backup restore-plan", "gitclaw backup retention-plan"}},
	...
	{Command: "/checkpoints", Aliases: []string{"/checkpoint", "/rollback"}, Model: "gitclaw/checkpoints", Category: "checkpoint", Summary: "Catalog or inspect git rollback readiness, checkpoint metadata, and checkpoint risk posture without restoring files or printing diffs.", LocalCLI: []string{"gitclaw checkpoints catalog", "gitclaw checkpoints status", "gitclaw checkpoints list", "gitclaw checkpoints risk", "gitclaw checkpoints verify", "gitclaw rollback catalog", "gitclaw rollback list", "gitclaw rollback risk"}},
	...
	{Command: "/hooks", Aliases: []string{"/hook"}, Model: "gitclaw/hooks", Category: "hooks", Summary: "Audit declarative hook policy, hook specs, ignored handlers, event-driven automation boundaries, hook risk posture, and hook git provenance.", LocalCLI: []string{"gitclaw hooks list", "gitclaw hooks risk", "gitclaw hooks verify", "gitclaw hooks provenance"}},
	...
	{Command: "/models", Aliases: []string{"/model"}, Model: "gitclaw/models", Category: "model", Summary: "Show, usage-audit, cost-audit, or risk-audit model provider, endpoint, token source, fallback, retry, normalized token telemetry, and GitHub Models cost-estimation support.", LocalCLI: []string{"gitclaw models list", "gitclaw models usage", "gitclaw models cost", "gitclaw models risk"}},
	...
	{Command: "/profile", Aliases: []string{"/profiles"}, Model: "gitclaw/profile", Category: "profile", Summary: "Catalog, show, verify, dry-run package, or risk-audit the repo-local profile envelope across soul, memory, skills, tools, model, proactive, backup, session, and channel gates.", LocalCLI: []string{"gitclaw profile catalog", "gitclaw profile show", "gitclaw profile verify", "gitclaw profile manifest", "gitclaw profile export-plan", "gitclaw profile risk"}},
	{Command: "/prompt", Aliases: []string{"/budget", "/prompt-budget"}, Model: "gitclaw/prompt", Category: "prompt", Summary: "Show prompt budget, packing, cache-readiness, compression/compaction readiness, truncation, context, skill, tool-output metadata, and prompt risk posture.", LocalCLI: []string{"gitclaw prompt list", "gitclaw prompt pack", "gitclaw prompt cache", "gitclaw prompt compression", "gitclaw prompt risk"}},
	...
	{Command: "/session", Model: "gitclaw/session", Category: "session", Summary: "Catalog, show, status-check, summarize, search, coverage-check, or risk-audit reconstructed transcript counts, markers, trust, provenance, and hashes.", LocalCLI: []string{"gitclaw session catalog", "gitclaw session list --backup <issue.json>", "gitclaw session status --backup <issue.json>", "gitclaw session stats --backup <issue.json>", "gitclaw session coverage --backup <issue.json>", "gitclaw session risk --backup <issue.json>", "gitclaw session search <query> --backup <issue.json>"}},
	{Command: "/skills", Model: "gitclaw/skills", Category: "skills", Summary: "List local skill metadata, compact eligibility catalogs, git provenance, trust verification, runtime metadata, risk audit, source pins, validation findings, selection/refresh/proposal/install/upgrade plans, or one focused skill info/search report.", LocalCLI: []string{"gitclaw skills verify", "gitclaw skills risk", "gitclaw skills runtime", "gitclaw skills catalog", "gitclaw skills validate", "gitclaw skills check", "gitclaw skills list", "gitclaw skills provenance", "gitclaw skills select-plan <name>", "gitclaw skills refresh-plan", "gitclaw skills sources", "gitclaw skills sources risk", "gitclaw skills sources info <name>", "gitclaw skills proposals [risk]", "gitclaw skills proposal-plan <name>", "gitclaw skills install-plan <target>", "gitclaw skills upgrade-plan <target>", "gitclaw skills info <name>", "gitclaw skills search <query>"}},
	{Command: "/soul", Model: "gitclaw/soul", Category: "soul", Summary: "Audit, compact-catalog, map, verify, inspect git provenance for, plan edits for, risk-scan, or search high-authority context files and soul validation findings.", LocalCLI: []string{"gitclaw soul catalog", "gitclaw soul anchors", "gitclaw soul provenance", "gitclaw soul verify", "gitclaw soul risk", "gitclaw soul validate", "gitclaw soul list", "gitclaw soul edit-plan <path>", "gitclaw soul info <path>", "gitclaw soul search <query>"}},
