...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/tools", Model: "gitclaw/tools", Category: "tools", Summary: "Audit, verify, risk-scan, inspect, plan runs for, search, or inspect repo-reviewed toolsets for deterministic tool contracts.", LocalCLI: []string{"gitclaw tools verify", "gitclaw tools risk", "gitclaw tools validate", "gitclaw tools list", "gitclaw tools toolsets", "gitclaw tools toolsets risk", "gitclaw tools toolsets info <name>", "gitclaw tools run-plan <name>", "gitclaw tools info <name>", "gitclaw tools search <query>"}},
