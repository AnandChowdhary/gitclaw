...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/models", Aliases: []string{"/model"}, Model: "gitclaw/models", Category: "model", Summary: "Show, usage-audit, or risk-audit model provider, endpoint, token source, fallback, retry, and normalized token telemetry.", LocalCLI: []string{"gitclaw models list", "gitclaw models usage", "gitclaw models risk"}},
