...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/skills", Model: "gitclaw/skills", Category: "skills", Summary: "List local skill metadata, selection state, validation findings, or one focused skill info/search report.", LocalCLI: []string{"gitclaw skills validate", "gitclaw skills check", "gitclaw skills list", "gitclaw skills info <name>", "gitclaw skills search <query>"}},
