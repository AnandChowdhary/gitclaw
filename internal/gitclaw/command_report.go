...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/channels", Aliases: []string{"/channel"}, Model: "gitclaw/channels", Category: "channels", Summary: "Audit channel bridge settings, workflow-dispatch ingress, outbound reply outboxes, provider contracts, risk posture, queue outbound channel messages with `/channels send`, queue provider-visible status/progress updates, queue provider message edits, probe reviewed routes, react or pin from mirrored channel issues, reply from mirrored channel issues, turn mirrored channel messages into GitHub tasks, save mirrored channel moments as GitHub clips, record mirrored channel attachments as GitHub metadata issues, record mirrored channel decisions as GitHub issues, record mirrored channel digests as GitHub issues, turn mirrored channel sessions into GitHub session handoff issues, turn mirrored channel messages into reviewed tool-run request issues, turn mirrored channel messages into tool rehearsal issues, turn mirrored channel messages into skill rehearsal issues, turn mirrored channel messages into soul rehearsal issues, turn mirrored channel messages into memory rehearsal issues, turn mirrored channel messages into backup recovery rehearsal issues, turn mirrored channel messages into scheduled GitHub reminder issues, close channel-created artifacts with provider-facing acknowledgements, broadcast to multiple reviewed routes, invite reviewed routes into a GitHub issue, create a durable GitHub room, create a GitHub huddle, open a GitHub poll, or run a GitHub rollcall and invite channel routes into it.", LocalCLI: []string{"gitclaw channels verify", "gitclaw channels risk", "gitclaw channels list", "gitclaw channels info <provider>", "gitclaw channel-ingest", "gitclaw channel-send", "gitclaw channel-status", "gitclaw channel-edit", "gitclaw channel-react", "gitclaw channel-send --route <name>", "gitclaw channel-state", "gitclaw channel-gateway", "gitclaw channel-outbox", "gitclaw channel-delivery"}},
