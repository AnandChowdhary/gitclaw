...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/backup", Aliases: []string{"/backups"}, Model: "gitclaw/backup", Category: "backup", Summary: "Show expected backup branch paths and inspect fetched backups, coverage, restore-readiness drills, risk posture, manifests, timelines, retention, restore plans, and search metadata.", LocalCLI: []string{"gitclaw backup verify", "gitclaw backup coverage --issue <number>", "gitclaw backup drill --issue <number>", "gitclaw backup risk", "gitclaw backup manifest", "gitclaw backup list", "gitclaw backup timeline", "gitclaw backup info --issue <number>", "gitclaw backup stats", "gitclaw backup search <query>", "gitclaw backup export-jsonl", "gitclaw backup restore-plan", "gitclaw backup retention-plan"}},
	...
	{Command: "/tools", Model: "gitclaw/tools", Category: "tools", Summary: "Audit, verify, risk-scan, inspect exposure and provenance, plan runs for, search, or inspect repo-reviewed toolsets for deterministic tool contracts.", LocalCLI: []string{"gitclaw tools verify", "gitclaw tools risk", "gitclaw tools validate", "gitclaw tools list", "gitclaw tools exposure", "gitclaw tools exposure risk", "gitclaw tools provenance [query]", "gitclaw tools toolsets", "gitclaw tools toolsets risk", "gitclaw tools toolsets info <name>", "gitclaw tools run-plan <name>", "gitclaw tools info <name>", "gitclaw tools search <query>"}},
