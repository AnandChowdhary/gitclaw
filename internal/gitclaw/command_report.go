...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/session", Model: "gitclaw/session", Category: "session", Summary: "Show, search, coverage-check, or risk-audit reconstructed transcript counts, markers, trust, provenance, and hashes.", LocalCLI: []string{"gitclaw session list --backup <issue.json>", "gitclaw session coverage --backup <issue.json>", "gitclaw session risk --backup <issue.json>", "gitclaw session search <query> --backup <issue.json>"}},
