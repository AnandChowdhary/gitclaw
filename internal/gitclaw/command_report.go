...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/prompt", Aliases: []string{"/budget", "/prompt-budget"}, Model: "gitclaw/prompt", Category: "prompt", Summary: "Show prompt budget, packing, truncation, context, skill, tool-output metadata, and prompt risk posture.", LocalCLI: []string{"gitclaw prompt list", "gitclaw prompt pack", "gitclaw prompt risk"}},
