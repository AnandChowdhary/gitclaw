...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/session", Model: "gitclaw/session", Category: "session", Summary: "Catalog, show, inspect prompt provenance for, audit tool-use, skill-use, token-usage, and trajectory ledgers for, status-check, summarize, search, coverage-check, or risk-audit reconstructed transcript counts, markers, trust, provenance, and hashes.", LocalCLI: []string{"gitclaw session catalog", "gitclaw session list --backup <issue.json>", "gitclaw session provenance --backup <issue.json>", "gitclaw session tools --backup <issue.json>", "gitclaw session skills --backup <issue.json>", "gitclaw session usage --backup <issue.json>", "gitclaw session trajectory --backup <issue.json>", "gitclaw session status --backup <issue.json>", "gitclaw session stats --backup <issue.json>", "gitclaw session coverage --backup <issue.json>", "gitclaw session risk --backup <issue.json>", "gitclaw session search <query> --backup <issue.json>"}},
	{Command: "/skills", Model: "gitclaw/skills", Category: "skills", Summary: "List local skill metadata, compact eligibility catalogs, git provenance, trust verification, runtime metadata, risk audit, source pins, validation findings, selection/refresh/proposal/install/upgrade plans, or one focused skill info/search report.", LocalCLI: []string{"gitclaw skills verify", "gitclaw skills risk", "gitclaw skills runtime", "gitclaw skills catalog", "gitclaw skills validate", "gitclaw skills check", "gitclaw skills list", "gitclaw skills provenance", "gitclaw skills select-plan <name>", "gitclaw skills refresh-plan", "gitclaw skills sources", "gitclaw skills sources provenance", "gitclaw skills sources risk", "gitclaw skills sources info <name>", "gitclaw skills proposals [risk]", "gitclaw skills proposal-plan <name>", "gitclaw skills install-plan <target>", "gitclaw skills upgrade-plan <target>", "gitclaw skills info <name>", "gitclaw skills search <query>"}},
