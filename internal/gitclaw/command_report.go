...
var commandCatalog = []commandCatalogEntry{
	...
	{Command: "/skills", Model: "gitclaw/skills", Category: "skills", Summary: "List local skill metadata, trust verification, risk audit, validation findings, selection/refresh/install/upgrade plans, or one focused skill info/search report.", LocalCLI: []string{"gitclaw skills verify", "gitclaw skills risk", "gitclaw skills validate", "gitclaw skills check", "gitclaw skills list", "gitclaw skills select-plan <name>", "gitclaw skills refresh-plan", "gitclaw skills install-plan <target>", "gitclaw skills upgrade-plan <target>", "gitclaw skills info <name>", "gitclaw skills search <query>"}},
