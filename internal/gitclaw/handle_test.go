...
`)
	...
	body := github.Posted[0].Body
	for _, want := range []string{"GitClaw Config Report", "Generated without a model call", "model=\"gitclaw/config\"", "config_source: `defaults+repo`", "config_file_path: `.gitclaw/config.yml`", "config_file_present: `true`", "trigger_label: `gitclaw`", "trigger_prefix: `@gitclaw`", "run_mode: `read-only`", "max_prompt_bytes: `60000`", "max_output_tokens: `4000`", "skills_allowed_configured: `0`", "skills_disabled_configured: `0`", "tools_allowed_configured: `0`", "tools_disabled_configured: `0`", "workflows_present: `2`", "slash_commands: `29`", "### Tool Gates", "OWNER", "COLLABORATOR", "gitclaw:disabled", "/agents", "/approvals", "/bundles", "/channels", "/checkpoints", "/doctor", "/help", "/memory", "/models", "/profile", "/tasks", "/runs", "/sandbox", "/prompt", "/config", "/secrets", ".github/workflows/gitclaw.yml", ".github/workflows/gitclaw-heartbeat.yml", "sha256_12="} {
		if !strings.Contains(body, want) {
