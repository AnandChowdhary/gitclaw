...
func TestRenderChannelListReportCarriesDedicatedE2EMarker(t *testing.T) {
	...
	for _, want := range []string{
		...
		"`/channels research-spotlight <focus> --spotlight-id <id> --message-id <message>`",
		"`/channels research-map <focus> --map-id <id> --message-id <message>`",
		"`/channels tools --message-id <message>`",
		"`/channels tool-search <query> --message-id <message>`",
		"`/channels tool-info <tool> --message-id <message>`",
		"`/channels tool-spotlight <focus> --spotlight-id <id> --message-id <message>`",
		"`/channels tool-drill <focus> --drill-id <id> --message-id <message>`",
		...
		"`/channels icebreaker --icebreaker-id <id> --message-id <message>`",
		...
		"`/channels backup-spotlight <focus> --spotlight-id <id> --message-id <message>`",
		"`/channels backup-timeline --timeline-id <id> --message-id <message>`",
		"`/channels backup-freshness --freshness-id <id> --message-id <message>`",
		"`/channels backup-continuity --continuity-id <id> --message-id <message>`",
		...
		"`/channels soul-spotlight <focus> --spotlight-id <id> --message-id <message>`",
		...
		"`/channels riddle <theme> --riddle-id <id> --message-id <message>`",
		...
		"`/channels mad-libs <theme> --mad-libs-id <id> --message-id <message>`",
		...
		"`/channels cockpit <lane> --cockpit-id <id> --message-id <message>`",
