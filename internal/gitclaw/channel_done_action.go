...
func channelDoneArtifactRefFromBody(body string) (channelDoneArtifactRef, error) {
	...
	return channelDoneArtifactRef{}, fmt.Errorf("channel done requires a gitclaw:channel-task, gitclaw:channel-watch, gitclaw:channel-standing-order-proposal, gitclaw:backup-restore-request-issue, gitclaw:checkpoint-rehearsal-issue, gitclaw:channel-clip, gitclaw:channel-attachment, gitclaw:channel-decision, gitclaw:channel-digest, gitclaw:channel-idea, gitclaw:channel-retro, gitclaw:channel-playbook, gitclaw:channel-insight, gitclaw:channel-workspace-proposal, gitclaw:channel-board-card, gitclaw:channel-checklist, gitclaw:channel-toolset-proposal, gitclaw:channel-prompt-proposal, gitclaw:channel-bundle-proposal, gitclaw:channel-incident, gitclaw:channel-voice, gitclaw:channel-image, gitclaw:channel-link, gitclaw:channel-access-request, gitclaw:channel-contact, or gitclaw:channel-reminder issue")
}
