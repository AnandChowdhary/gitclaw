...
func channelDoneArtifactRefFromBody(body string) (channelDoneArtifactRef, error) {
	...
	return channelDoneArtifactRef{}, fmt.Errorf("channel done requires a gitclaw:channel-task, gitclaw:channel-clip, gitclaw:channel-decision, gitclaw:channel-digest, or gitclaw:channel-reminder issue")
}
