...
func channelDoneArtifactRefFromBody(body string) (channelDoneArtifactRef, error) {
	...
	if ref, ok := channelDoneArtifactRefFromMarker(body, "time-capsule", channelTimeCapsuleMarkerPattern, "capsule_id"); ok {
		return ref, nil
	}
	...
	if ref, ok := channelDoneArtifactRefFromMarker(body, "skill-note", channelSkillNoteMarkerPattern, "note_id"); ok {
		return ref, nil
	}
	if ref, ok := channelDoneArtifactRefFromMarker(body, "soul-note", channelSoulNoteMarkerPattern, "note_id"); ok {
		return ref, nil
	}
	if ref, ok := channelDoneArtifactRefFromMarker(body, "backup-note", channelBackupNoteMarkerPattern, "note_id"); ok {
		return ref, nil
	}
	if ref, ok := channelDoneArtifactRefFromMarker(body, "memory-note", channelMemoryNoteMarkerPattern, "note_id"); ok {
		return ref, nil
	}
	if ref, ok := channelDoneArtifactRefFromMarker(body, "idea", channelIdeaMarkerPattern, "idea_id"); ok {
		return ref, nil
	}
	if ref, ok := channelDoneArtifactRefFromMarker(body, "quest", channelQuestMarkerPattern, "quest_id"); ok {
		return ref, nil
	}
	if ref, ok := channelDoneArtifactRefFromMarker(body, "ritual", channelRitualMarkerPattern, "ritual_id"); ok {
		return ref, nil
	}
	if ref, ok := channelDoneArtifactRefFromMarker(body, "pact", channelPactMarkerPattern, "pact_id"); ok {
		return ref, nil
	}
	if ref, ok := channelDoneArtifactRefFromMarker(body, "forecast", channelForecastMarkerPattern, "forecast_id"); ok {
		return ref, nil
	}
	if ref, ok := channelDoneArtifactRefFromMarker(body, "lore", channelLoreMarkerPattern, "lore_id"); ok {
		return ref, nil
	}
	if ref, ok := channelDoneArtifactRefFromMarker(body, "boundary", channelBoundaryMarkerPattern, "boundary_id"); ok {
		return ref, nil
	}
	...
	if ref, ok := channelDoneArtifactRefFromMarker(body, "tool-lesson", channelToolLessonMarkerPattern, "note_id"); ok {
		return ref, nil
	}
	...
	if ref, ok := channelDoneArtifactRefFromMarker(body, "dock", channelDockMarkerPattern, "dock_id"); ok {
		return ref, nil
	}
	...
	return channelDoneArtifactRef{}, fmt.Errorf("channel done requires a gitclaw:channel-task, gitclaw:channel-watch, gitclaw:channel-standing-order-proposal, gitclaw:backup-restore-request-issue, gitclaw:checkpoint-rehearsal-issue, gitclaw:channel-clip, gitclaw:channel-open-loop, gitclaw:channel-attachment, gitclaw:channel-snippet, gitclaw:channel-decision, gitclaw:channel-digest, gitclaw:channel-journal, gitclaw:channel-time-capsule, gitclaw:channel-quote, gitclaw:channel-glossary, gitclaw:channel-faq, gitclaw:channel-skill-note, gitclaw:channel-soul-note, gitclaw:channel-backup-note, gitclaw:channel-memory-note, gitclaw:channel-idea, gitclaw:channel-quest, gitclaw:channel-ritual, gitclaw:channel-pact, gitclaw:channel-forecast, gitclaw:channel-lore, gitclaw:channel-boundary, gitclaw:channel-jam, gitclaw:channel-retro, gitclaw:channel-playbook, gitclaw:channel-insight, gitclaw:channel-workspace-proposal, gitclaw:channel-board-card, gitclaw:channel-checklist, gitclaw:channel-agenda, gitclaw:channel-tool-result, gitclaw:channel-tool-lesson, gitclaw:channel-toolset-proposal, gitclaw:channel-prompt-proposal, gitclaw:channel-bundle-proposal, gitclaw:channel-incident, gitclaw:channel-voice, gitclaw:channel-image, gitclaw:channel-link, gitclaw:channel-bookmark, gitclaw:channel-fork, gitclaw:channel-merge, gitclaw:channel-dock, gitclaw:channel-access-request, gitclaw:channel-contact, or gitclaw:channel-reminder issue")
}
