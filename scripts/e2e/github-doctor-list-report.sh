...
for expected in \
  ...
  'skill_files: `1`' \
  'e2e_scripts: `256`' \
  'e2e_live_issue_scripts: `249`' \
  'e2e_cleanup_scripts: `256`' \
  'e2e_model_coverage_scripts: `199`' \
  'e2e_model_followup_scripts: `199`' \
  'e2e_session_coverage_scripts: `2`' \
  'e2e_backup_gate_scripts: `30`' \
  'e2e_workflow_dispatch_scripts: `33`' \
  'enabled_skills: `1`' \
  'disabled_skills: `0`' \
  ...
  'path=`scripts/e2e/github-skills-sources-update-plan-report.sh`' \
  ...
  'path=`scripts/e2e/github-profile-provenance-report.sh`' \
  'path=`scripts/e2e/github-profile-search-report.sh`' \
  'path=`scripts/e2e/github-profile-diff-report.sh`' \
  'path=`scripts/e2e/github-profile-snapshot-report.sh`' \
  ...
  'path=`scripts/e2e/github-proactive-chain-report.sh`' \
  ...
  'path=`scripts/e2e/github-channel-send-workflow.sh`' \
  'path=`scripts/e2e/github-security-audit-report.sh`' \
