...
followup_token="GITCLAW_BACKUP_RESTORE_PLAN_FOLLOWUP_HIDDEN_${timestamp}"
expected_token="GITCLAW_BACKUP_RESTORE_PLAN_CONTEXT_V1"
search_phrase="backup restore plan unique search fixture phrase"
...
Do not abbreviate it to the GITCLAW_BACKUP_RESTORE_PLAN prefix.
